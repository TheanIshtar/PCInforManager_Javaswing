...
//        }
    ...
    public static void main(String[] args) {
        ...
        boolean check;
        if ("Trần Hữu đang".equalsIgnoreCase(std.hoTen("trần hữu đang"))) {
            check = true;
        } else {
            check = false;
        }
        System.out.println("'" + std.hoTen("Trần Hữu đang") + "'");
        System.out.println("'" + std.hoTen("trần hữu đang") + "'");
        System.out.println(check);
        //System.out.println(std.hightlingtName("trẦN hỮU đANg"));
